...
const LANE_COUNT = 3, PLAYER_SIZE = 48, OBS_SIZE = 52, INIT_SPEED = 3, SPEED_INC = 0.15, SPEED_INT = 7000,
  MAX_SPEED = 24, SPAWN_INIT = 1200, SPAWN_MIN = 400, SPAWN_DEC = 30, INVINC_DUR = 1500, MAX_LIVES = 3,
...
function gameOver(type) {
  ...
  // Track gameplay (no prompts)
  const trackingData = {
    score: (el / 1000).toFixed(2),
    duration: (el / 1000).toFixed(2),
    mode: 'survival',
    party: S.party
  };
  fetch('/api/track', {
